...
function ad_admin() {
  ...
  p_regP.style.display    = "none";                                  //<=======
  p_landingP.style.display = "none";                                  //<=======
  p_adP.style.display   = "block";                                 //<=======
...
function ad_home() {
  ...
  // ENSURE THE HTML ID ARE CORRECT                                      //<=======
  p_regP.style.display    = "none";                                  //<=======
  p_adP.style.display   = "none";                                  //<=======
  p_landingP.style.display = "block";                                 //<=======
}
...
function ad_user() {
  ...
  document.getElementById("b_adAD").style.backgroundColor   = "grey";
  // ENSURE THE READ FUNCTION NAME & THE PATH NAME ARE CORRECT           //<=======
  fb_adReadAll(DETAILS, ad_processUSERReadAll);                            //<=======
}

/**************************************************************/
// ad_AD()
// Input event; called when admin AD button clicked
// Display AD screen
// Input:   
// Return:
/**************************************************************/
function ad_AD() {
  ...
  document.getElementById("b_adAD").style.backgroundColor   = "cyan";
  document.getElementById("b_adUser").style.backgroundColor = "grey";
  document.getElementById("b_adHome").style.backgroundColor = "grey"; 
  // ENSURE THE READ FUNCTION NAME & THE PATH NAME ARE CORRECT           //<=======
  fb_adReadAll(USERSCORE, ad_processADReadAll);                                   //<=======
}
...
function ad_processUSERReadAll(_result, _dbRec) {
  ...
  if (_result == 'OK') {                                        
    ...
    ad_displayAll("t_userData", ad_adminArray, true,                     
      "p_landingP", "p_xo", "p_adP", 11, DETAILS);        //<=======
  }
}

/**************************************************************/
// ad_processADReadAll(_result, _dbRec)
// Called by db_readAll to handle result of read ALL AD records request.
// Save data & update display with record info
// Input:  read status "OK", data record just read. 
//         NOTE: this is the raw data, EG snapshot, NOT snapshot.val()
// Return:
/**************************************************************/
function ad_processADReadAll(_result, _dbRec) {
  console.log('ad_processADReadAll: ', 'result = ' + _result);
...
// Called by ad_dbRAllUResult & ad_dbRAllADResult
...
//  ad_displayAll("t_userData", dbArray, true, "landingP", "", "adminPage", 
//                1, DETAILS);
/**************************************************************/
